...
use Tektonik\Plates\Template\FileExtension;
...
class Engine
{
     ...
     */
    public function __construct(array $directory = null, $fileExtension = 'phtml')
    {
     ...
     * @return Engine
     */
    public function setDirectory(array $directory = null)
    {
